...
openssl aes-256-cbc -K $encrypted_7bc606770d22_key -iv $encrypted_7bc606770d22_iv -in .travis/o2-site.enc -out ~/.ssh/o2-site -d
...
# Checkout the master branch (Default is v2)
cd .deploy_git
git checkout master
# Deploy to GitHub
cd ..
