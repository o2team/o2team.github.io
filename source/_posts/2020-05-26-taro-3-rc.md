...
subtitle: 社区很多开发者使用上了 Taro Next，他们的帮助和赞誉加上我们内部项目使用的良好反馈，Beta 发布一个月之后，我们非常自信地发布了候选版（RC）版本。
cover: https://img13.360buyimg.com/ling/jfs/t1/131780/5/388/2331933/5ecce529E0df55626/0514d956b8866772.png
categories: 小程序
tags:
  - Taro
  - 小程序
...
你可以访问文档[渲染 HTML](https://taro-docs.jd.com/taro/next/docs/html.html "渲染 HTML")了解更多信息。
...
你可以访问文档[使用 CSS-in-JS](https://taro-docs.jd.com/taro/next/docs/css-in-js.html "使用 CSS-in-JS")了解更多信息。
...
你可以访问文档[长列表渲染](https://taro-docs.jd.com/taro/next/docs/virtual-list.html "长列表渲染")了解更多信息。
