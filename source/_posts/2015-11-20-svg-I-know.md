...
#我知道的SVG
----------
@(svg)[SVG in HTML|SVG Sprites|SVG形状|贝塞尔曲线|SVG动画|animateMotion|stroke|clip-path]
...
![svg-sprite]({{ post_img("svgSprite.jpg") }})
...
![三次贝塞尔曲线控制]({{ post_img("svgImage2.png") }})

![二次贝塞尔曲线控制]({{ post_img("svgImage3.png") }})
...
![光滑三次贝塞尔曲线]({{ post_img("svgImage4.png") }})
...
![光滑二次贝塞尔曲线]({{ post_img("svgImage5.png") }})
...
DEMO1: 
![clip-path]({{ post_img("svgBreakup.gif") }})
...
DEMO2：
![clip-path]({{ post_img("svgLine.gif") }})
